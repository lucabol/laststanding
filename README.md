...
| `l_exitif` | ✅ | test_fs.c |
| `l_getenv` | ✅ | gfx_test.c, test_fs.c, test_net.c, test_strings.c, test_utils.c, test.c |
| `l_getenv_init` | ✅ | gfx_test.c, test_fs.c, test_net.c, test_strings.c, test_utils.c, test.c |
