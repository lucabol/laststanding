...
// ── Embedded 8×12 bitmap font (ASCII 32–126) ────────────────────────────────
// Derived from l_font8x8 by vertical row-doubling using pattern
// {0,0,1,2,2,3,4,4,5,6,6,7} — a true 1.5× vertical scale that keeps
// bitmap pixels crisp (no AA / no blur). Cell is 8 wide, 12 tall, advance 8.
// 95 glyphs × 12 bytes = 1140 bytes; gc-sections drops it if unreferenced.
#define L_F8X12_ROW(b0,b1,b2,b3,b4,b5,b6,b7) \
    {b0,b0,b1,b2,b2,b3,b4,b4,b5,b6,b6,b7}
static const uint8_t l_font8x12[95][12] = {
    L_F8X12_ROW(0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00), // 32 ' '
    L_F8X12_ROW(0x18,0x3C,0x3C,0x18,0x18,0x00,0x18,0x00), // 33 '!'
    L_F8X12_ROW(0x36,0x36,0x00,0x00,0x00,0x00,0x00,0x00), // 34 '"'
    L_F8X12_ROW(0x36,0x36,0x7F,0x36,0x7F,0x36,0x36,0x00), // 35 '#'
    L_F8X12_ROW(0x0C,0x3E,0x03,0x1E,0x30,0x1F,0x0C,0x00), // 36 '$'
    L_F8X12_ROW(0x00,0x63,0x33,0x18,0x0C,0x66,0x63,0x00), // 37 '%'
    L_F8X12_ROW(0x1C,0x36,0x1C,0x6E,0x3B,0x33,0x6E,0x00), // 38 '&'
    L_F8X12_ROW(0x06,0x06,0x03,0x00,0x00,0x00,0x00,0x00), // 39 '''
    L_F8X12_ROW(0x18,0x0C,0x06,0x06,0x06,0x0C,0x18,0x00), // 40 '('
    L_F8X12_ROW(0x06,0x0C,0x18,0x18,0x18,0x0C,0x06,0x00), // 41 ')'
    L_F8X12_ROW(0x00,0x66,0x3C,0xFF,0x3C,0x66,0x00,0x00), // 42 '*'
    L_F8X12_ROW(0x00,0x0C,0x0C,0x3F,0x0C,0x0C,0x00,0x00), // 43 '+'
    L_F8X12_ROW(0x00,0x00,0x00,0x00,0x00,0x0C,0x0C,0x06), // 44 ','
    L_F8X12_ROW(0x00,0x00,0x00,0x3F,0x00,0x00,0x00,0x00), // 45 '-'
    L_F8X12_ROW(0x00,0x00,0x00,0x00,0x00,0x0C,0x0C,0x00), // 46 '.'
    L_F8X12_ROW(0x60,0x30,0x18,0x0C,0x06,0x03,0x01,0x00), // 47 '/'
    L_F8X12_ROW(0x3E,0x63,0x73,0x7B,0x6F,0x67,0x3E,0x00), // 48 '0'
    L_F8X12_ROW(0x0C,0x0E,0x0C,0x0C,0x0C,0x0C,0x3F,0x00), // 49 '1'
    L_F8X12_ROW(0x1E,0x33,0x30,0x1C,0x06,0x33,0x3F,0x00), // 50 '2'
    L_F8X12_ROW(0x1E,0x33,0x30,0x1C,0x30,0x33,0x1E,0x00), // 51 '3'
    L_F8X12_ROW(0x38,0x3C,0x36,0x33,0x7F,0x30,0x78,0x00), // 52 '4'
    L_F8X12_ROW(0x3F,0x03,0x1F,0x30,0x30,0x33,0x1E,0x00), // 53 '5'
    L_F8X12_ROW(0x1C,0x06,0x03,0x1F,0x33,0x33,0x1E,0x00), // 54 '6'
    L_F8X12_ROW(0x3F,0x33,0x30,0x18,0x0C,0x0C,0x0C,0x00), // 55 '7'
    L_F8X12_ROW(0x1E,0x33,0x33,0x1E,0x33,0x33,0x1E,0x00), // 56 '8'
    L_F8X12_ROW(0x1E,0x33,0x33,0x3E,0x30,0x18,0x0E,0x00), // 57 '9'
    L_F8X12_ROW(0x00,0x0C,0x0C,0x00,0x00,0x0C,0x0C,0x00), // 58 ':'
    L_F8X12_ROW(0x00,0x0C,0x0C,0x00,0x00,0x0C,0x0C,0x06), // 59 ';'
    L_F8X12_ROW(0x18,0x0C,0x06,0x03,0x06,0x0C,0x18,0x00), // 60 '<'
    L_F8X12_ROW(0x00,0x00,0x3F,0x00,0x00,0x3F,0x00,0x00), // 61 '='
    L_F8X12_ROW(0x06,0x0C,0x18,0x30,0x18,0x0C,0x06,0x00), // 62 '>'
    L_F8X12_ROW(0x1E,0x33,0x30,0x18,0x0C,0x00,0x0C,0x00), // 63 '?'
    L_F8X12_ROW(0x3E,0x63,0x7B,0x7B,0x7B,0x03,0x1E,0x00), // 64 '@'
    L_F8X12_ROW(0x0C,0x1E,0x33,0x33,0x3F,0x33,0x33,0x00), // 65 'A'
    L_F8X12_ROW(0x3F,0x66,0x66,0x3E,0x66,0x66,0x3F,0x00), // 66 'B'
    L_F8X12_ROW(0x3C,0x66,0x03,0x03,0x03,0x66,0x3C,0x00), // 67 'C'
    L_F8X12_ROW(0x1F,0x36,0x66,0x66,0x66,0x36,0x1F,0x00), // 68 'D'
    L_F8X12_ROW(0x7F,0x46,0x16,0x1E,0x16,0x46,0x7F,0x00), // 69 'E'
    L_F8X12_ROW(0x7F,0x46,0x16,0x1E,0x16,0x06,0x0F,0x00), // 70 'F'
    L_F8X12_ROW(0x3C,0x66,0x03,0x03,0x73,0x66,0x7C,0x00), // 71 'G'
    L_F8X12_ROW(0x33,0x33,0x33,0x3F,0x33,0x33,0x33,0x00), // 72 'H'
    L_F8X12_ROW(0x1E,0x0C,0x0C,0x0C,0x0C,0x0C,0x1E,0x00), // 73 'I'
    L_F8X12_ROW(0x78,0x30,0x30,0x30,0x33,0x33,0x1E,0x00), // 74 'J'
    L_F8X12_ROW(0x67,0x66,0x36,0x1E,0x36,0x66,0x67,0x00), // 75 'K'
    L_F8X12_ROW(0x0F,0x06,0x06,0x06,0x46,0x66,0x7F,0x00), // 76 'L'
    L_F8X12_ROW(0x63,0x77,0x7F,0x7F,0x6B,0x63,0x63,0x00), // 77 'M'
    L_F8X12_ROW(0x63,0x67,0x6F,0x7B,0x73,0x63,0x63,0x00), // 78 'N'
    L_F8X12_ROW(0x1C,0x36,0x63,0x63,0x63,0x36,0x1C,0x00), // 79 'O'
    L_F8X12_ROW(0x3F,0x66,0x66,0x3E,0x06,0x06,0x0F,0x00), // 80 'P'
    L_F8X12_ROW(0x1E,0x33,0x33,0x33,0x3B,0x1E,0x38,0x00), // 81 'Q'
    L_F8X12_ROW(0x3F,0x66,0x66,0x3E,0x36,0x66,0x67,0x00), // 82 'R'
    L_F8X12_ROW(0x1E,0x33,0x07,0x0E,0x38,0x33,0x1E,0x00), // 83 'S'
    L_F8X12_ROW(0x3F,0x2D,0x0C,0x0C,0x0C,0x0C,0x1E,0x00), // 84 'T'
    L_F8X12_ROW(0x33,0x33,0x33,0x33,0x33,0x33,0x3F,0x00), // 85 'U'
    L_F8X12_ROW(0x33,0x33,0x33,0x33,0x33,0x1E,0x0C,0x00), // 86 'V'
    L_F8X12_ROW(0x63,0x63,0x63,0x6B,0x7F,0x77,0x63,0x00), // 87 'W'
    L_F8X12_ROW(0x63,0x63,0x36,0x1C,0x1C,0x36,0x63,0x00), // 88 'X'
    L_F8X12_ROW(0x33,0x33,0x33,0x1E,0x0C,0x0C,0x1E,0x00), // 89 'Y'
    L_F8X12_ROW(0x7F,0x63,0x31,0x18,0x4C,0x66,0x7F,0x00), // 90 'Z'
    L_F8X12_ROW(0x1E,0x06,0x06,0x06,0x06,0x06,0x1E,0x00), // 91 '['
    L_F8X12_ROW(0x03,0x06,0x0C,0x18,0x30,0x60,0x40,0x00), // 92 '\'
    L_F8X12_ROW(0x1E,0x18,0x18,0x18,0x18,0x18,0x1E,0x00), // 93 ']'
    L_F8X12_ROW(0x08,0x1C,0x36,0x63,0x00,0x00,0x00,0x00), // 94 '^'
    L_F8X12_ROW(0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF), // 95 '_'
    L_F8X12_ROW(0x0C,0x0C,0x18,0x00,0x00,0x00,0x00,0x00), // 96 '`'
    L_F8X12_ROW(0x00,0x00,0x1E,0x30,0x3E,0x33,0x6E,0x00), // 97 'a'
    L_F8X12_ROW(0x07,0x06,0x06,0x3E,0x66,0x66,0x3B,0x00), // 98 'b'
    L_F8X12_ROW(0x00,0x00,0x1E,0x33,0x03,0x33,0x1E,0x00), // 99 'c'
    L_F8X12_ROW(0x38,0x30,0x30,0x3E,0x33,0x33,0x6E,0x00), //100 'd'
    L_F8X12_ROW(0x00,0x00,0x1E,0x33,0x3F,0x03,0x1E,0x00), //101 'e'
    L_F8X12_ROW(0x1C,0x36,0x06,0x0F,0x06,0x06,0x0F,0x00), //102 'f'
    L_F8X12_ROW(0x00,0x00,0x6E,0x33,0x33,0x3E,0x30,0x1F), //103 'g'
    L_F8X12_ROW(0x07,0x06,0x36,0x6E,0x66,0x66,0x67,0x00), //104 'h'
    L_F8X12_ROW(0x0C,0x00,0x0E,0x0C,0x0C,0x0C,0x1E,0x00), //105 'i'
    L_F8X12_ROW(0x30,0x00,0x30,0x30,0x30,0x33,0x33,0x1E), //106 'j'
    L_F8X12_ROW(0x07,0x06,0x66,0x36,0x1E,0x36,0x67,0x00), //107 'k'
    L_F8X12_ROW(0x0E,0x0C,0x0C,0x0C,0x0C,0x0C,0x1E,0x00), //108 'l'
    L_F8X12_ROW(0x00,0x00,0x33,0x7F,0x7F,0x6B,0x63,0x00), //109 'm'
    L_F8X12_ROW(0x00,0x00,0x1F,0x33,0x33,0x33,0x33,0x00), //110 'n'
    L_F8X12_ROW(0x00,0x00,0x1E,0x33,0x33,0x33,0x1E,0x00), //111 'o'
    L_F8X12_ROW(0x00,0x00,0x3B,0x66,0x66,0x3E,0x06,0x0F), //112 'p'
    L_F8X12_ROW(0x00,0x00,0x6E,0x33,0x33,0x3E,0x30,0x78), //113 'q'
    L_F8X12_ROW(0x00,0x00,0x3B,0x6E,0x66,0x06,0x0F,0x00), //114 'r'
    L_F8X12_ROW(0x00,0x00,0x3E,0x03,0x1E,0x30,0x1F,0x00), //115 's'
    L_F8X12_ROW(0x08,0x0C,0x3E,0x0C,0x0C,0x2C,0x18,0x00), //116 't'
    L_F8X12_ROW(0x00,0x00,0x33,0x33,0x33,0x33,0x6E,0x00), //117 'u'
    L_F8X12_ROW(0x00,0x00,0x33,0x33,0x33,0x1E,0x0C,0x00), //118 'v'
    L_F8X12_ROW(0x00,0x00,0x63,0x6B,0x7F,0x7F,0x36,0x00), //119 'w'
    L_F8X12_ROW(0x00,0x00,0x63,0x36,0x1C,0x36,0x63,0x00), //120 'x'
    L_F8X12_ROW(0x00,0x00,0x33,0x33,0x33,0x3E,0x30,0x1F), //121 'y'
    L_F8X12_ROW(0x00,0x00,0x3F,0x19,0x0C,0x26,0x3F,0x00), //122 'z'
    L_F8X12_ROW(0x38,0x0C,0x0C,0x07,0x0C,0x0C,0x38,0x00), //123 '{'
    L_F8X12_ROW(0x18,0x18,0x18,0x00,0x18,0x18,0x18,0x00), //124 '|'
    L_F8X12_ROW(0x07,0x0C,0x0C,0x38,0x0C,0x0C,0x07,0x00), //125 '}'
    L_F8X12_ROW(0x6E,0x3B,0x00,0x00,0x00,0x00,0x00,0x00), //126 '~'
};
...
// ── Default ASCII 8×12 font wrapped as L_Font ───────────────────────────────
// Crisp 1.5× line-height tier for callers (e.g. OscaWeb FONT_DEFAULT_L).
static const L_FontRange l_font8x12_default_ranges_[] = {
    { 32, 95, &l_font8x12[0][0], 0 },
};
static const L_Font l_font8x12_default = {
    l_font8x12_default_ranges_, 1, 0, 0, 0, 0, 8, 12, 8, 0, '?'
};
...
// 8×12 proportional: reuses the 95-byte widths table from the 8×8 font.
static const L_FontRange l_font8x12_proportional_ranges_[] = {
    { 32, 95, &l_font8x12[0][0], l_font8x8_ascii_widths_data },
};
static const L_Font l_font8x12_proportional = {
    l_font8x12_proportional_ranges_, 1, 0, 0, 0, 0, 8, 12, 8, 0, '?'
};
#endif
...
// 8×12 Latin-1 variant. Latin-1 supplement glyphs must be row-doubled too so
// both ranges agree on cell_h — mixing 8- and 12-row data in one L_Font would
// break the `bitmap + idx * cell_h` stride math in l_font_lookup_raw.
static const uint8_t l_font8x12_latin1_supp_data[96][12] = {
    L_F8X12_ROW(0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00), // U+00A0
    L_F8X12_ROW(0x18,0x00,0x18,0x18,0x3C,0x3C,0x18,0x00), // U+00A1
    L_F8X12_ROW(0x08,0x1C,0x36,0x06,0x36,0x1C,0x08,0x00), // U+00A2
    L_F8X12_ROW(0x1C,0x36,0x06,0x1F,0x06,0x66,0x3F,0x00), // U+00A3
    L_F8X12_ROW(0x00,0x42,0x3C,0x24,0x24,0x3C,0x42,0x00), // U+00A4
    L_F8X12_ROW(0x33,0x33,0x1E,0x3F,0x0C,0x3F,0x0C,0x00), // U+00A5
    L_F8X12_ROW(0x18,0x18,0x18,0x00,0x18,0x18,0x18,0x00), // U+00A6
    L_F8X12_ROW(0x1E,0x33,0x06,0x1E,0x30,0x33,0x1E,0x00), // U+00A7
    L_F8X12_ROW(0x36,0x36,0x00,0x00,0x00,0x00,0x00,0x00), // U+00A8
    L_F8X12_ROW(0x3C,0x42,0x99,0xA5,0xA5,0x99,0x42,0x3C), // U+00A9
    L_F8X12_ROW(0x1C,0x30,0x3C,0x33,0x6E,0x00,0x7E,0x00), // U+00AA
    L_F8X12_ROW(0x00,0x66,0x33,0x19,0x33,0x66,0x00,0x00), // U+00AB
    L_F8X12_ROW(0x00,0x00,0x00,0x3F,0x30,0x00,0x00,0x00), // U+00AC
    L_F8X12_ROW(0x00,0x00,0x00,0x3F,0x00,0x00,0x00,0x00), // U+00AD
    L_F8X12_ROW(0x3C,0x42,0xB1,0xA9,0xA9,0xB1,0x42,0x3C), // U+00AE
    L_F8X12_ROW(0x3F,0x00,0x00,0x00,0x00,0x00,0x00,0x00), // U+00AF
    L_F8X12_ROW(0x1C,0x36,0x36,0x1C,0x00,0x00,0x00,0x00), // U+00B0
    L_F8X12_ROW(0x00,0x0C,0x0C,0x3F,0x0C,0x0C,0x3F,0x00), // U+00B1
    L_F8X12_ROW(0x1E,0x30,0x1C,0x06,0x3E,0x00,0x00,0x00), // U+00B2
    L_F8X12_ROW(0x1E,0x30,0x1C,0x30,0x1E,0x00,0x00,0x00), // U+00B3
    L_F8X12_ROW(0x10,0x08,0x00,0x00,0x00,0x00,0x00,0x00), // U+00B4
    L_F8X12_ROW(0x00,0x00,0x33,0x33,0x33,0x3F,0x03,0x03), // U+00B5
    L_F8X12_ROW(0x7E,0x1B,0x1B,0x1E,0x18,0x18,0x18,0x00), // U+00B6
    L_F8X12_ROW(0x00,0x00,0x00,0x18,0x18,0x00,0x00,0x00), // U+00B7
    L_F8X12_ROW(0x00,0x00,0x00,0x00,0x00,0x00,0x18,0x0C), // U+00B8
    L_F8X12_ROW(0x0C,0x0E,0x0C,0x0C,0x1E,0x00,0x00,0x00), // U+00B9
    L_F8X12_ROW(0x1C,0x36,0x36,0x1C,0x00,0x7E,0x00,0x00), // U+00BA
    L_F8X12_ROW(0x00,0x66,0xCC,0x98,0xCC,0x66,0x00,0x00), // U+00BB
    L_F8X12_ROW(0x06,0x46,0x66,0x36,0x1E,0xFB,0x60,0xF0), // U+00BC
    L_F8X12_ROW(0x06,0x46,0x66,0x36,0x1E,0xCB,0xE6,0xC2), // U+00BD
    L_F8X12_ROW(0x0E,0x4C,0x6C,0x3E,0x1B,0xFB,0x60,0xF0), // U+00BE
    L_F8X12_ROW(0x0C,0x00,0x0C,0x06,0x33,0x30,0x1E,0x00), // U+00BF
    L_F8X12_ROW(0x08,0x10,0x0C,0x1E,0x33,0x33,0x3F,0x33), // U+00C0
    L_F8X12_ROW(0x10,0x08,0x0C,0x1E,0x33,0x33,0x3F,0x33), // U+00C1
    L_F8X12_ROW(0x18,0x24,0x0C,0x1E,0x33,0x33,0x3F,0x33), // U+00C2
    L_F8X12_ROW(0x68,0x16,0x0C,0x1E,0x33,0x33,0x3F,0x33), // U+00C3
    L_F8X12_ROW(0x24,0x24,0x0C,0x1E,0x33,0x33,0x3F,0x33), // U+00C4
    L_F8X12_ROW(0x18,0x24,0x0C,0x1E,0x33,0x33,0x3F,0x33), // U+00C5
    L_F8X12_ROW(0x00,0x00,0x7E,0x1B,0x7F,0xDB,0xDB,0x00), // U+00C6
    L_F8X12_ROW(0x3C,0x66,0x03,0x03,0x03,0x66,0x3C,0x0C), // U+00C7
    L_F8X12_ROW(0x08,0x10,0x7F,0x46,0x16,0x1E,0x16,0x46), // U+00C8
    L_F8X12_ROW(0x10,0x08,0x7F,0x46,0x16,0x1E,0x16,0x46), // U+00C9
    L_F8X12_ROW(0x18,0x24,0x7F,0x46,0x16,0x1E,0x16,0x46), // U+00CA
    L_F8X12_ROW(0x24,0x24,0x7F,0x46,0x16,0x1E,0x16,0x46), // U+00CB
    L_F8X12_ROW(0x08,0x10,0x1E,0x0C,0x0C,0x0C,0x0C,0x0C), // U+00CC
    L_F8X12_ROW(0x10,0x08,0x1E,0x0C,0x0C,0x0C,0x0C,0x0C), // U+00CD
    L_F8X12_ROW(0x18,0x24,0x1E,0x0C,0x0C,0x0C,0x0C,0x0C), // U+00CE
    L_F8X12_ROW(0x24,0x24,0x1E,0x0C,0x0C,0x0C,0x0C,0x0C), // U+00CF
    L_F8X12_ROW(0x1E,0x36,0x66,0x6F,0x66,0x36,0x1E,0x00), // U+00D0
    L_F8X12_ROW(0x68,0x16,0x63,0x67,0x6F,0x7B,0x73,0x63), // U+00D1
    L_F8X12_ROW(0x08,0x10,0x1C,0x36,0x63,0x63,0x63,0x36), // U+00D2
    L_F8X12_ROW(0x10,0x08,0x1C,0x36,0x63,0x63,0x63,0x36), // U+00D3
    L_F8X12_ROW(0x18,0x24,0x1C,0x36,0x63,0x63,0x63,0x36), // U+00D4
    L_F8X12_ROW(0x68,0x16,0x1C,0x36,0x63,0x63,0x63,0x36), // U+00D5
    L_F8X12_ROW(0x24,0x24,0x1C,0x36,0x63,0x63,0x63,0x36), // U+00D6
    L_F8X12_ROW(0x00,0x00,0x33,0x1E,0x0C,0x1E,0x33,0x00), // U+00D7
    L_F8X12_ROW(0x60,0x3C,0x73,0x7B,0x6F,0x67,0x3C,0x06), // U+00D8
    L_F8X12_ROW(0x08,0x10,0x33,0x33,0x33,0x33,0x33,0x33), // U+00D9
    L_F8X12_ROW(0x10,0x08,0x33,0x33,0x33,0x33,0x33,0x33), // U+00DA
    L_F8X12_ROW(0x18,0x24,0x33,0x33,0x33,0x33,0x33,0x33), // U+00DB
    L_F8X12_ROW(0x24,0x24,0x33,0x33,0x33,0x33,0x33,0x33), // U+00DC
    L_F8X12_ROW(0x10,0x08,0x33,0x33,0x33,0x1E,0x0C,0x0C), // U+00DD
    L_F8X12_ROW(0x00,0x00,0x06,0x3E,0x66,0x66,0x3E,0x06), // U+00DE
    L_F8X12_ROW(0x1E,0x33,0x33,0x1F,0x33,0x33,0x1F,0x03), // U+00DF
    L_F8X12_ROW(0x08,0x10,0x1E,0x30,0x3E,0x33,0x6E,0x00), // U+00E0
    L_F8X12_ROW(0x10,0x08,0x1E,0x30,0x3E,0x33,0x6E,0x00), // U+00E1
    L_F8X12_ROW(0x18,0x24,0x1E,0x30,0x3E,0x33,0x6E,0x00), // U+00E2
    L_F8X12_ROW(0x68,0x16,0x1E,0x30,0x3E,0x33,0x6E,0x00), // U+00E3
    L_F8X12_ROW(0x24,0x24,0x1E,0x30,0x3E,0x33,0x6E,0x00), // U+00E4
    L_F8X12_ROW(0x18,0x24,0x1E,0x30,0x3E,0x33,0x6E,0x00), // U+00E5
    L_F8X12_ROW(0x00,0x00,0x6E,0x33,0x6F,0xDB,0x76,0x00), // U+00E6
    L_F8X12_ROW(0x00,0x00,0x1E,0x33,0x03,0x33,0x1E,0x0C), // U+00E7
    L_F8X12_ROW(0x08,0x10,0x1E,0x33,0x3F,0x03,0x1E,0x00), // U+00E8
    L_F8X12_ROW(0x10,0x08,0x1E,0x33,0x3F,0x03,0x1E,0x00), // U+00E9
    L_F8X12_ROW(0x18,0x24,0x1E,0x33,0x3F,0x03,0x1E,0x00), // U+00EA
    L_F8X12_ROW(0x24,0x24,0x1E,0x33,0x3F,0x03,0x1E,0x00), // U+00EB
    L_F8X12_ROW(0x08,0x10,0x0E,0x0C,0x0C,0x0C,0x1E,0x00), // U+00EC
    L_F8X12_ROW(0x10,0x08,0x0E,0x0C,0x0C,0x0C,0x1E,0x00), // U+00ED
    L_F8X12_ROW(0x18,0x24,0x0E,0x0C,0x0C,0x0C,0x1E,0x00), // U+00EE
    L_F8X12_ROW(0x24,0x24,0x0E,0x0C,0x0C,0x0C,0x1E,0x00), // U+00EF
    L_F8X12_ROW(0x00,0x00,0x1E,0x33,0x3B,0x37,0x1E,0x00), // U+00F0
    L_F8X12_ROW(0x68,0x16,0x1F,0x33,0x33,0x33,0x33,0x00), // U+00F1
    L_F8X12_ROW(0x08,0x10,0x1E,0x33,0x33,0x33,0x1E,0x00), // U+00F2
    L_F8X12_ROW(0x10,0x08,0x1E,0x33,0x33,0x33,0x1E,0x00), // U+00F3
    L_F8X12_ROW(0x18,0x24,0x1E,0x33,0x33,0x33,0x1E,0x00), // U+00F4
    L_F8X12_ROW(0x68,0x16,0x1E,0x33,0x33,0x33,0x1E,0x00), // U+00F5
    L_F8X12_ROW(0x24,0x24,0x1E,0x33,0x33,0x33,0x1E,0x00), // U+00F6
    L_F8X12_ROW(0x00,0x0C,0x00,0x3F,0x00,0x0C,0x00,0x00), // U+00F7
    L_F8X12_ROW(0x00,0x40,0x3E,0x73,0x6B,0x67,0x3E,0x02), // U+00F8
    L_F8X12_ROW(0x08,0x10,0x33,0x33,0x33,0x33,0x6E,0x00), // U+00F9
    L_F8X12_ROW(0x10,0x08,0x33,0x33,0x33,0x33,0x6E,0x00), // U+00FA
    L_F8X12_ROW(0x18,0x24,0x33,0x33,0x33,0x33,0x6E,0x00), // U+00FB
    L_F8X12_ROW(0x24,0x24,0x33,0x33,0x33,0x33,0x6E,0x00), // U+00FC
    L_F8X12_ROW(0x10,0x08,0x33,0x33,0x33,0x3E,0x30,0x1F), // U+00FD
    L_F8X12_ROW(0x00,0x00,0x06,0x3E,0x66,0x66,0x3E,0x06), // U+00FE
    L_F8X12_ROW(0x24,0x24,0x33,0x33,0x33,0x3E,0x30,0x1F), // U+00FF
};
static const L_FontRange l_font8x12_latin1_ranges_[] = {
    { 32,    95, &l_font8x12[0][0],                   0 },
    { 0x00A0, 96, &l_font8x12_latin1_supp_data[0][0], 0 },
};
static const L_Font l_font8x12_latin1 = {
    l_font8x12_latin1_ranges_, 2, 0, 0, 0, 0, 8, 12, 8, 0, '?'
};
#endif
...
// 8×12 box-drawing variant. Sparse bitmap is row-doubled to match cell_h=12.
static const uint8_t l_font8x12_box_data[][12] = {
    L_F8X12_ROW(0x00,0x10,0x30,0x7F,0x30,0x10,0x00,0x00), // U+2190
    L_F8X12_ROW(0x00,0x18,0x3C,0x7E,0x18,0x18,0x18,0x00), // U+2191
    L_F8X12_ROW(0x00,0x08,0x0C,0xFE,0x0C,0x08,0x00,0x00), // U+2192
    L_F8X12_ROW(0x00,0x18,0x18,0x18,0x7E,0x3C,0x18,0x00), // U+2193
    L_F8X12_ROW(0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00), // U+2500
    L_F8X12_ROW(0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18), // U+2502
    L_F8X12_ROW(0x00,0x00,0x00,0xF8,0x18,0x18,0x18,0x18), // U+250C
    L_F8X12_ROW(0x00,0x00,0x00,0x1F,0x18,0x18,0x18,0x18), // U+2510
    L_F8X12_ROW(0x18,0x18,0x18,0xF8,0x00,0x00,0x00,0x00), // U+2514
    L_F8X12_ROW(0x18,0x18,0x18,0x1F,0x00,0x00,0x00,0x00), // U+2518
    L_F8X12_ROW(0x18,0x18,0x18,0xF8,0x18,0x18,0x18,0x18), // U+251C
    L_F8X12_ROW(0x18,0x18,0x18,0x1F,0x18,0x18,0x18,0x18), // U+2524
    L_F8X12_ROW(0x00,0x00,0x00,0xFF,0x18,0x18,0x18,0x18), // U+252C
    L_F8X12_ROW(0x18,0x18,0x18,0xFF,0x00,0x00,0x00,0x00), // U+2534
    L_F8X12_ROW(0x18,0x18,0x18,0xFF,0x18,0x18,0x18,0x18), // U+253C
    L_F8X12_ROW(0x00,0x00,0xFF,0x00,0xFF,0x00,0x00,0x00), // U+2550
    L_F8X12_ROW(0x36,0x36,0x36,0x36,0x36,0x36,0x36,0x36), // U+2551
    L_F8X12_ROW(0x00,0x00,0xFC,0x0C,0xEC,0x2C,0x2C,0x2C), // U+2554
    L_F8X12_ROW(0x00,0x00,0x3F,0x30,0x37,0x34,0x34,0x34), // U+2557
    L_F8X12_ROW(0x2C,0x2C,0x2F,0x20,0x3F,0x00,0x00,0x00), // U+255A
    L_F8X12_ROW(0x34,0x34,0x37,0x30,0x3F,0x00,0x00,0x00), // U+255D
    L_F8X12_ROW(0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00,0x00), // U+2580
    L_F8X12_ROW(0x00,0x00,0x00,0x00,0xFF,0xFF,0xFF,0xFF), // U+2584
    L_F8X12_ROW(0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF), // U+2588
    L_F8X12_ROW(0x0F,0x0F,0x0F,0x0F,0x0F,0x0F,0x0F,0x0F), // U+258C
    L_F8X12_ROW(0xF0,0xF0,0xF0,0xF0,0xF0,0xF0,0xF0,0xF0), // U+2590
    L_F8X12_ROW(0x55,0xAA,0x55,0xAA,0x55,0xAA,0x55,0xAA), // U+2591
    L_F8X12_ROW(0x55,0xFF,0xAA,0xFF,0x55,0xFF,0xAA,0xFF), // U+2592
    L_F8X12_ROW(0xAA,0xFF,0x55,0xFF,0xAA,0xFF,0x55,0xFF), // U+2593
    L_F8X12_ROW(0x00,0x00,0x7E,0x7E,0x7E,0x7E,0x00,0x00), // U+25A0
    L_F8X12_ROW(0x00,0x00,0x7E,0x42,0x42,0x7E,0x00,0x00), // U+25A1
    L_F8X12_ROW(0x00,0x18,0x24,0x42,0x42,0x24,0x18,0x00), // U+25CB
    L_F8X12_ROW(0x00,0x18,0x3C,0x7E,0x7E,0x3C,0x18,0x00), // U+25CF
};
static const L_FontRange l_font8x12_box_ranges_[] = {
    { 32, 95, &l_font8x12[0][0], 0 },
};
static const L_Font l_font8x12_box = {
    l_font8x12_box_ranges_, 1,
    l_font8x8_box_codepoints, &l_font8x12_box_data[0][0], 0,
    L_FONT_BOX_GLYPH_COUNT,
    8, 12, 8, 0, '?'
};
#endif
